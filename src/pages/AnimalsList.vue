<template>
    <div>
        <div class="container mt-5">
            ...
            <p>
                Benvenuti al nostro centro veterinario, dedicato alla cura e al benessere degli animali da compagnia.
            </p>
            <p>
                Siamo un team di veterinari altamente qualificati e appassionati, con anni di esperienza nella cura di
                animali di tutte le razze e dimensioni.
            </p>
            <p>
            ...
            <div class="row">
                <div class="col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Dott. Mario Rossi</h5>
                            <p class="card-text">Specializzato in cani e gatti.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-4 mb-4">
